...
|:------:|:-----:|:-----------:|:---------:|:----------:|
| MAE (log10 Hz) | CNN | 0.0716 | 0.0752 | 0.0954 |
|  | GRU | 0.0737 | 0.0798 | 0.0982 |
|  | CNN-GRU | **0.0676** | **0.0743** | **0.0945** |
|  |  |  |  |  |
| MAE (MHz) | CNN | 7.99 | 7.37 | **7.06** |
|  | GRU | 8.03 | 7.71 | 8.03 |
|  | CNN-GRU | **6.80** | **6.61** | 7.23 |
|  |  |  |  |  |
| MSE (log10 Hz) | CNN | 0.0178 | 0.0150 | 0.0228 |
|  | GRU | 0.0164 | 0.0162 | 0.0249 |
|  | CNN-GRU | **0.0145** | **0.0133** | 0.0231 |
|  |  |  |  |  |
| MSE (MHz^2) | CNN | 1.99e3 | 1.21e3 | 0.13e3 |
|  | GRU | 1.48e3 | 0.70e3 | 0.28e3 |
|  | CNN-GRU | **0.43e3** | **0.25e3** | **0.12e3** |
|  |  |  |  |  |
| MAPE (%) | CNN | 17.52 | 18.58 | 25.94 |
|  | GRU | 18.56 | 20.24 | 28.71 |
