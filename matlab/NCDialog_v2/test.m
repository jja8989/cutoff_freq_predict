...
% disp(errorChangeRate)

% figure(2)
% loglog(10.^FreqSearchRange , MSE) , grid on , grid minor

mask = errorChangeRate > 0;
% disp(mask)
...
CutOffFreqIndex = find(errorChangeRate == min(errorChangeRate(1:end-1)));
