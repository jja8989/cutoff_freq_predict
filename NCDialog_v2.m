...
if isempty(fileDefault) == 1
    ...
    NCDialogPara.CapacitorArea = '10000';      % [um2]
    NCDialogPara.QresTolerance = '4';          % [%]
    NCDialogPara.PulseWidth = '500';           % [ns]
    NCDialogPara.PulseRiseFall = '20';         % [ns] 
